...
```javascript
stdevch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevch@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-array-stdevch/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-array-stdevch/actions/workflows/test.yml?query=branch:v0.1.1
