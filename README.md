...
```javascript
stdevch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevch@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-array-stdevch/tags). For example,

```javascript
stdevch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevch@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var stdevch = require( 'path/to/vendor/umd/stats-array-stdevch/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevch@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-array-stdevch.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-array-stdevch

[test-image]: https://github.com/stdlib-js/stats-array-stdevch/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-array-stdevch/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-array-stdevch/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-array-stdevch?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-array-stdevch.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-array-stdevch/main
...
[branches-url]: https://github.com/stdlib-js/stats-array-stdevch/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-array-stdevch/main/LICENSE
